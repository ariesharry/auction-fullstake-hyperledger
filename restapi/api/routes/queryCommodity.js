...
async function createAuction (ccp, wallet, user, query) {
	try {
		...
		const result = await contract.evaluateTransaction('queryNamed', query);
...
router.post('/', async function (req, res, next) {
    ...
    try {
        ...
        if (org === "Org1" || org === "org1") {
            ...
            result = await createAuction(ccp, wallet, user, query);
